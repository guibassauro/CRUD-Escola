...
public interface AlunoService {
    ...
    List<Aluno> achaTodosOsAlunosDeUmCurso(Long curso_id);
    ...
    String matriculaAluno(CriaMatriculaRequest criaMatricula);

    String desmatriculaAluno(CriaMatriculaRequest deletaMatricula);
}
